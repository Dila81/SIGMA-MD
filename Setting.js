...
global.owner = process.env.OWNER_NUMBER  || '237694525931' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://ndehurich:8VmBZUeGPSkIY0x0@cluster0.71cvbxa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"❚♥︎ End",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '23_04_2024_SIGMA_MD_gbgdUDyV_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Dilan-Bot',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `NDE DILAN`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'NDE DILAN      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "end_pack" ,          // ADD YOUR STICKER PACKNAME
